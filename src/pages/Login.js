...
const Login = () => {
  ...
  return (
    <div>
      ...
      <Container>
        <Bredcrumb />
        <p className="mb-14 w-full font-nuni text-base font-normal text-secondary lg:w-1/2">
          ...
          <div className="mb-12 border-y border-y-smoke py-20">
            ...
            <Flex className="mb-8 flex flex-wrap items-center justify-between gap-y-5 xl:gap-y-7 xl:gap-x-10">
              <div className="relative w-full lg:w-[48%]">
                ...
                />
                {errorMsg.email && (
                  <div className="absolute -bottom-6 left-0 font-nuni text-base font-normal text-red-500">
                    {errorMsg.email}
                  </div>
                )}
              </div>
            ...
            <div className="mt-3 font-nuni text-base font-normal">
        ...
        <Modal isOpen={modalOpen} onClose={closeModal}>
          <h2 className="mb-6 text-center font-nuni text-3xl font-normal text-primary">
            Forgot Password?
          </h2>
          <p className="pb-2 text-left font-nuni text-base font-normal text-primary">
          ...
          {errorMsg.forgotPassword && (
            <div className="absolute bottom-[92px] left-[34px] font-nuni text-base font-normal text-red-500">
              {errorMsg.forgotPassword}
            </div>
          )}
          {!forgotPassLoading && (
            <button
              ...
              className="mt-10 h-[50px] w-[100%] border-2 border-transparent bg-primary font-nuni text-sm font-bold text-white transition-all duration-100 ease-linear hover:border-2 hover:border-primary hover:bg-pure hover:text-primary"
            >
              Get OTP Code
            </button>
          )}
